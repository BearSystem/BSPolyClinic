...
{
    public partial class PolyClinicV10001 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorMedicalSpeciality_MedicalSpecialties_MedicalSpecialityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorHealthCenter", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorHealthCenter_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorHealthCenter_HealthCenters_HealthCenterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthCenterMedicalSpeciality", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HealthCenterMedicalSpeciality_HealthCenters_HealthCenterId",
                        column: x => x.HealthCenterId,
                        principalTable: "HealthCenters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HealthCenterMedicalSpeciality_MedicalSpecialties_MedicalSpecialityId",
                        column: x => x.MedicalSpecialityId,
                        principalTable: "MedicalSpecialties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthCenterNurses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HealthCenterNurses_HealthCenters_HealthCenterId",
                        column: x => x.HealthCenterId,
                        principalTable: "HealthCenters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HealthCenterNurses_Nurses_NurseId",
                        column: x => x.NurseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Phones_HealthCenters_HealthCenterId",
                        column: x => x.HealthCenterId,
                        principalTable: "HealthCenters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorHealthCenter_DoctorId",
                table: "DoctorHealthCenter",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorHealthCenter_HealthCenterId",
                table: "DoctorHealthCenter",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthCenterMedicalSpeciality_HealthCenterId",
                table: "HealthCenterMedicalSpeciality",
                column: "HealthCenterId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthCenterMedicalSpeciality_MedicalSpecialityId",
                table: "HealthCenterMedicalSpeciality",
                column: "MedicalSpecialityId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthCenterNurses_HealthCenterId",
                table: "HealthCenterNurses",
                column: "HealthCenterId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthCenterNurses_NurseId",
                table: "HealthCenterNurses",
                column: "NurseId");
